...
const EditarTarefa = ({ handleCloseEditar, idTarefaSelecionada, tarefas, tarefa, setTarefas }) => {
  ...
  useEffect(() => {
    const tarefaEditada = tarefas.find(t => t.idTarefa === idTarefaSelecionada);
    if (tarefaEditada) {
      setTituloTarefa(tarefaEditada.tituloTarefa);
      setDescricaoTarefa(tarefaEditada.descricaoTarefa);
      setInicioTarefa(tarefaEditada.inicioTarefa);
      setFimTarefa(tarefaEditada.fimTarefa);
      setRecursoTarefa(tarefaEditada.recursoTarefa);
      setStatusTarefa(tarefaEditada.statusTarefa);
    }
  ...
  const handleEditar = () => {
    ...
    const tarefasAtualizadas = tarefas.map(t => (t.idTarefa === idTarefaSelecionada ? tarefaEditada : t));
