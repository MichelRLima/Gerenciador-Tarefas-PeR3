...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        // Filtra as tarefas removendo aquela com o ID especificado
        const novasTarefas = tarefas.filter(tarefa => tarefa.idTarefa !== id);

        // Atualiza o estado das tarefas com as tarefas filtradas
  ...
  // Em outras partes do código onde houver alteração das tarefas
  // após edição, criação ou qualquer outra modificação:
  // Exemplo:
  // setTarefas(novasTarefas);
  // localStorage.setItem('tarefas', JSON.stringify(novasTarefas));
